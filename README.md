...
[![CI](https://github.com/Roberdan/convergio-doctor/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-doctor/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-doctor/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-doctor] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-doctor = { git = "https://github.com/Roberdan/convergio-doctor", tag = "v0.1.0" }
```
