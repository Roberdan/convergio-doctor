...
const SMOKE_ROUTES: &[(&str, &str)] = &[
    ...
    ("capabilities", "/api/capabilities/health-monitoring"),
    ("capabilities", "/api/capabilities/local-inference"),
    ("capabilities", "/api/capabilities/stt"),
    ("capabilities", "/api/capabilities/telegram-watchdog"),
    ("capabilities", "/api/capabilities/tts"),
    ("capabilities", "/api/capabilities/voice-pipeline"),
    ("capabilities", "/api/capabilities/voice-routing"),
